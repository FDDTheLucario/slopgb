...
| [sgb-arcade-takeover.md](sgb-arcade-takeover.md) | Full-takeover protocol black-box pinned from the pilot: the BIOS-runtime WRAM/entry-point contract, resident firmware, ACK path, current wall |
